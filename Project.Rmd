...
```{r}
fullmodel=lm(X2014~X2013+X2012+X2011+X2010,data=YE)
summary(fullmodel)
```
...
plot(YE$X2014,YE$X2013)
abline(coef=coef(fullmodel), col='red')
#predict(fullmodel)
plot(YE$X2014,fullmodel$res, ylab="e_bar", xlab="y_bar")
abline(0,0)
...
hist(YE$X2014, breaks =10)
hist(YE$X2013,breaks =10)
hist(YE$X2012,breaks =10)
hist(YE$X2011,breaks =10)
hist(YE$X2010,breaks =10)
